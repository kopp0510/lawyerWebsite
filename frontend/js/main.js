...
const CASES_DATA_FALLBACK = [
  { name: '廣鎰有限公司', img: '', category: '貿易業', desc: '提供常年法律顧問服務，協助企業合約審閱、勞資爭議處理及商業糾紛諮詢，保障企業營運的法律安全。' },
  { name: '鑫裕芳有限公司', img: '', category: '零售業', desc: '擔任企業法律顧問，提供營運法律風險評估、契約擬定及員工管理相關法律諮詢服務。' },
  { name: '裕芳食品', img: '', category: '食品業', desc: '協助食品產業法規遵循、消費者保護法相關諮詢、品牌商標保護及供應商合約管理。' },
  { name: '威鋒貿易有限公司', img: '', category: '貿易業', desc: '處理國際貿易法律事務、進出口合約審閱、貿易糾紛調解及跨國商業法律諮詢。' },
  { name: '詠裕體育事業社', img: '', category: '體育事業', desc: '提供體育事業相關法律服務，包含賽事合約、贊助協議審閱及智慧財產權保護。' },
  { name: '超湛股份有限公司', img: '', category: '製造業', desc: '擔任常年法律顧問，協助公司治理、股東權益保障及商業訴訟代理。' },
  { name: '帝崴營造股份有限公司', img: '', category: '營造業', desc: '處理營建工程法律事務、工程合約擬定與審閱、工程款糾紛及勞安法規諮詢。' },
  { name: '展豐建設股份有限公司', img: '', category: '建設業', desc: '提供不動產開發法律服務、建案契約管理、都市更新法規諮詢及購屋糾紛處理。' },
